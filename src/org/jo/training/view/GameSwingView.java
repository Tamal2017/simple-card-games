...
public class GameSwingView implements GameViewable {
  ...
  @Override
  public void showCardForPlayer(int playerIndex, String playerName, String cardRank,
      String cardSuit) {
  ...
  public void showWinner(String winnerName) {
    appendText("The winner : " + winnerName);
  }
  ...
  public void promptForPlayerName() {
    ...
    int addMore = JOptionPane
        .showConfirmDialog(frame, "Add more players ?", "More players", JOptionPane.YES_NO_OPTION);
  ...
  public void promptForNewGame() {
    int newGame = JOptionPane
        .showConfirmDialog(frame, "Play again ?", "Play again", JOptionPane.YES_NO_OPTION);
